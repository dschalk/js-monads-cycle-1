...
var updateScoreboard = function updateScoreboard(v) {
  ...
  for (var k in keys) {
    mMscoreboard.bnd(unshift, (0, _cycleDom.h)('p', ar[k]));
  }
  mMscoreboard.bnd(unshift, (0, _cycleDom.h)('p', 'player [score] [goals]'));
  return mMscoreboard;
};
...
var updateMessages = function updateMessages(v) {
  ...
  var keys = Object.keys(ar);
  for (var k in keys) {
    mMmessages.bnd(unshift, (0, _cycleDom.h)('div', ar[k]));
  }
  return mMmessages;
};
...
_cycleCore2['default'].run(main, sources);
